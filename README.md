...
- **Multi-agent orchestration** — spawns planner, coder, reviewer, debugger, and researcher sub-agents with **OpenAI Swarm-Style Dynamic Handoffs (`handoff_task`)** and shared **Context Variables (`contextVariables`)** for seamless mid-turn role transfers.
