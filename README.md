...
- **Windows + Unix** — full cross-platform support ### Tools
...
- **Codebase** — index, find, definitions, references ### Commands <!-- START_COMMANDS_TABLE -->
| Command | Description |
|---------|-------------|
...
* [Configuration Reference Guide](docs/configuration-reference.md) — Reference list of all global configuration keys (`router.*`, `agents.*`, `tools.*`, `ui.*`, etc.). --- ## Development ```bash
