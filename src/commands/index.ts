...
const helpCommand: Command = {
  ...
  execute: async (args, _ctx) => {
    ...
    for (const cmd of commandsList) {
      ...
      } else if (['tui', 'image', 'autopilot', 'preview', 'branch', 'pr', 'debug', 'commit', 'project', 'test', 'watch', 'index', 'find', 'refs', 'def', 'callgraph', 'impact', 'ci', 'badge', 'changelog', 'models', 'config', 'doctor', 'stats', 'health', 'shortcut', 'sc', 'blacklist'].includes(name)) {
